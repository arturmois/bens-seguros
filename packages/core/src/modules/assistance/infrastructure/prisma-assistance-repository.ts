...
export class PrismaAssistanceRepository implements AssistanceRepository {
  ...
  async findById(id: string, organizationId: string): Promise<AssistanceData | null> {
  ...
  async findMany(filters: AssistanceFilters, page: CursorPage): Promise<Page<AssistanceData>> {
