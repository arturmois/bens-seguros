...
export function invitationEmail(params: InvitationParams): string {
  return baseLayout(`
    <h2 style="font-size:20px;font-weight:600;color:#0d4f4f;margin:0 0 16px;">Convite para Organizacao</h2>
    <p style="font-size:14px;color:#3f3f46;line-height:1.6;margin:0 0 16px;">
      <strong>${params.inviterName}</strong> convidou voce para participar da organizacao
    ...
    <p style="font-size:12px;color:#71717a;margin:16px 0 0;">Se voce nao reconhece este convite, pode ignorar este email.</p>
  `)
}
