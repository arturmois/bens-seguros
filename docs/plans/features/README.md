...
| F08     | Advanced Dashboard — period presets, KPI comparatives, financial metrics, broker ranking, export PDF             |
...
**Total:** 10 features | 9 concluidas/removidas | 0 em design | 4 longo prazo
