...
import type { ContactData, ConversationData, MessageData, Page } from '../domain/types.js';
...
export class GetConversation {
  ...
  async execute(conversationId: string, tenantId: string): Promise<GetConversationResult> {
