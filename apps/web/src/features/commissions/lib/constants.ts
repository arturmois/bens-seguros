...
export const COMMISSION_STATUS_COLORS: Record<CommissionStatus, string> = {
  PENDING_COMMERCIAL: 'bg-amber-100 text-amber-700 dark:bg-amber-900 dark:text-amber-300',
  PENDING_ADMIN: 'bg-orange-100 text-orange-700 dark:bg-orange-900 dark:text-orange-300',
