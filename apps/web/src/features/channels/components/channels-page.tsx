...
export function ChannelsPage() {
  ...
  const [editingChannel, setEditingChannel] = useState<ChannelData | undefined>(undefined);
  const [qrChannel, setQrChannel] = useState<ChannelData | null>(null);
  const [deactivateChannel, setDeactivateChannel] = useState<ChannelData | null>(null);
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold tracking-tight">Canais WhatsApp</h2>
      ...
      <ChannelFormSheet open={formOpen} onOpenChange={setFormOpen} channel={editingChannel} />
    ...
    return (
      <Empty>
        <EmptyHeader>
          ...
          <EmptyDescription>Nao foi possivel carregar os canais. Tente novamente.</EmptyDescription>
        </EmptyHeader>
    ...
    return (
      <Empty>
        <EmptyHeader>
          ...
          <EmptyDescription>
            Adicione seu primeiro canal WhatsApp para comecar a receber mensagens.
          </EmptyDescription>
        </EmptyHeader>
