...
import { ASSISTANCE_STATUS_COLORS, ASSISTANCE_STATUS_LABELS } from '../lib/constants';
...
export function AssistanceStatusBadge({ status, className }: AssistanceStatusBadgeProps) {
  return (
    <span
      className={cn(
