...
export function DashboardPreview(): React.ReactElement {
  return (
    <div className="animate-float mx-auto mt-16 max-w-4xl">
      <div className="border-white/8 supports-backdrop-filter:bg-white/3 rounded-2xl border bg-slate-900/80 p-5 shadow-[0_20px_60px_rgba(0,0,0,0.3)] backdrop-blur-xl">
        <WindowChrome />
...
function StatCard({ label, value, change }: StatCardProps): React.ReactElement {
  return (
    <div className="border-white/6 bg-white/4 rounded-xl border p-4">
...
function MiniBarChart(): React.ReactElement {
  return (
    <div className="border-white/6 bg-white/4 mt-4 flex items-end gap-1.5 rounded-xl border p-4">
